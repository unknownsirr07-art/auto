...
BOT_TOKEN = environ.get('BOT_TOKEN', "8540329120:AAERBWC_pR8SvdY6LnVbL_DtTsNaYWoaWY8")
...
CHANNELS = environ.get('CHANNELS', '-1001778573048')
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '921365334 1153569236 1986274156 1085808214 5515283997 8823073292').split()]
...
MONGO_TIMEOUT_MS = int(environ.get('MONGO_TIMEOUT_MS', '10000'))
MONGO_OPTIONS = {
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/The_Silent_Teamz')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'The_Silent_Teamz')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "True")), True)
IMDB = is_enabled((environ.get('IMDB', "False")), False)
AUTO_FFILTER = is_enabled((environ.get('AUTO_FFILTER', "True")), True)
AUTO_DELETE = is_enabled((environ.get('AUTO_DELETE', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "False")), True)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "[{file_name}](https://t.me/The_Silent_Teamz)\n\n<b>Join Our Offical Channel & Group @The_Silent_Teamz ❤️") # f"{script.CAPTION}")
